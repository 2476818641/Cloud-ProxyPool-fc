...
[cloud.redis]
addr = "{redis_conf['addr']}"
password = "{redis_conf['password']}"
db = {redis_conf['db']}
key_prefix = "{redis_conf['key_prefix']}"
lease_ttl_seconds = {redis_conf['lease_ttl_seconds']}
cooldown_seconds = {redis_conf['cooldown_seconds']}
acquire_retries = {redis_conf['acquire_retries']}
retry_delay_ms = {redis_conf['retry_delay_ms']}
"""
...
def conf_redis_defaults():
    ...
    return {
        "addr": redis_conf.get("addr", "127.0.0.1:6379"),
